...
if __name__ == '__main__':
    ...
    # Need to get the downtown area
    arcpy.SelectLayerByLocation_management(in_layer = target_features, overlap_type="INTERSECT", select_features="DowntownLandCover", search_distance="", selection_type="NEW_SELECTION", invert_spatial_relationship="NOT_INVERT")
